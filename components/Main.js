...
import HideButtonA from "./HideButtonA.js";
import HideButtonI from "./HideButtonI.js";
// The container
...
import Context from "../../displayWeatherApp/Context";
  ...
  return (
    <View style={styles.container}>
      <Content>
        ...
        >
          <Header />
          {/* <Text style={styles.header}>The Shining</Text> */}
          ...
          {!searchShow && (
            ...
            >
              ...
              >
                {Platform.OS === "ios" ? <HideButtonI /> : <HideButtonA />}
              </TouchableOpacity>
            </View>
          )}
